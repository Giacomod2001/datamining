...
def render_navigation():
    ...
    with st.sidebar:
        ...
        with st.expander(gdpr_compliance.t("data_mgmt"), expanded=False):
            st.caption(gdpr_compliance.t("data_mgmt_caption"))
            if st.button(
                gdpr_compliance.t("delete_btn"),
                key="sidebar_delete_data",

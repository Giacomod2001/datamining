...
HARD_SKILLS = {
    ...
    # Energy & Renewable (User Requested - Enhanced)
    "Energy Engineering": ["energy engineering", "ingegneria energetica"],
    "Renewable Energy": ["renewable energy", "energie rinnovabili"],
    "Solar Energy": ["solar energy", "fotovoltaico", "photovoltaics", "pv"],
    "Wind Energy": ["wind energy", "eolico"],
    "Energy Efficiency": ["energy efficiency", "efficienza energetica"],
    "Thermodynamics": ["thermodynamics", "termodinamica"],
    "Power Systems": ["power systems", "sistemi elettrici"],
    "Energy Modeling": ["energy modeling", "pvsyst", "homer"],
    ...
    "Interpreting": ["interpreting", "interpretariato"],
